...
function getTreeInfo(node) {
   ...
   // this will be diameter of any given node
   ...
   const diameter = Math.max(maxDiameterSoFar, currentNodeDiameter);
   // current height will be 1 more of either left's height or right's height,
   // whichever greater
